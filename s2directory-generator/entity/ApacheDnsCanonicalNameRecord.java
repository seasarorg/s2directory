...
public class ApacheDnsCanonicalNameRecord implements Serializable {
	private static final long serialVersionUID = 1L;
	private String dn;
	private String apacheDnsDomainName;

	public ApacheDnsCanonicalNameRecord() {
		super();
	}

	public ApacheDnsCanonicalNameRecord(String apacheDnsDomainName) {
		super();

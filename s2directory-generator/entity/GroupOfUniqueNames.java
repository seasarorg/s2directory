...
public class GroupOfUniqueNames implements Serializable {
	...
	public GroupOfUniqueNames(String uniqueMember, String cn) {
		super();
	...
	public String toString() {
		...
		buffer.append("MUST: ");
		buffer.append("uniqueMember=").append(uniqueMember).append(", ");

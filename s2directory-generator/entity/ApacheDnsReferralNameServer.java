...
public class ApacheDnsReferralNameServer implements Serializable {
	private static final long serialVersionUID = 1L;
	private String dn;
	private String apacheDnsDomainName;

	public ApacheDnsReferralNameServer() {
		super();
	}

	public ApacheDnsReferralNameServer(String apacheDnsDomainName) {
		super();

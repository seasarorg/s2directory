...
import org.seasar.directory.tiger.examples.client.DefaultDirectoryInformationTreeTest;
	...
	protected void setUp() throws Exception {
		...
		if (container == null) {
			...
			posixAccountWithAnnocationDirectoryDao =
				(PosixAccountWithAnnocationDirectoryDao)container
					.getComponent(PosixAccountWithAnnocationDirectoryDao.class);
		}

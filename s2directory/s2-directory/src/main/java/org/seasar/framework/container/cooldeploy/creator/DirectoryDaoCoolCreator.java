...
/**
 * CoolDeploy時にDirecotryDaoのインスタンスを管理するクールクリエータです。
 * 
 * @author Jun Futagawa (Integsystem Corporation)
 * @version $Date::                           $
 */
public class DirectoryDaoCoolCreator extends SinglePackageCoolCreator {
	/**
	 * インスタンスを作成します。
	 * 
	 * @param namingConvention
	 */
	public DirectoryDaoCoolCreator(NamingConvention namingConvention) {

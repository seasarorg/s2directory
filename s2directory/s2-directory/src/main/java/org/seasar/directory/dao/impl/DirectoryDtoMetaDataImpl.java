...
public class DirectoryDtoMetaDataImpl implements DirectoryDtoMetaData {
	...
	protected ValueType getValueType(PropertyDesc propertyDesc) {
		...
		if (valueTypeName != null) {
			return getDirectoryAttributeHandlerFactory().getDirectoryValueTypeFactory().getValueTypeByName(
				valueTypeName);
		} else {
			return getDirectoryAttributeHandlerFactory().getDirectoryValueTypeFactory().getValueTypeByClass(

...
public abstract class AbstractAttributeHandler implements AttributeHandler {
	...
	public Attribute getAddAttribute(DirectoryControlProperty property,
		...
		if (value == null)
			return null;
		DirectoryValueTypeFactory valueTypeFactory = getDirectoryValueTypeFactory();
	...
	public ModificationItem getModificationItem(
		...
		if (currentAttribute != null) {
			...
			Object currentValue = stringValueType.getReadValue(
					currentAttribute, property.getMultipleValueDelimiter());
			if (newValue == null || StringUtil.isEmpty(stringValue)) {
				...
				Attribute attribute = getAddAttribute(property, attributeName,
						newValue, newValueClass);
